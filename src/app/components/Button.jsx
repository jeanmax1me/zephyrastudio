...
function Button({invert,href,className,children, ...props}) {
  className = clsx(className, "inline-flex rounded-full px-4 py-1.5 text-sm font-semibold transition", invert ? "text-white hover:bg-neutral-800" : "text-neutral-950 hover:bg-neutral-200"
  );
